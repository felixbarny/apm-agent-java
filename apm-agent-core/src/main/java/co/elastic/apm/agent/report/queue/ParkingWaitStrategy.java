...
public class ParkingWaitStrategy implements MessagePassingQueue.WaitStrategy, Signaller {

    private final Thread consumerThread;
    private final AtomicBoolean signalNeeded = new AtomicBoolean(false);
    private final long parkTimeNanos;

    public ParkingWaitStrategy(Thread consumerThread, long parkTimeNanos) {
